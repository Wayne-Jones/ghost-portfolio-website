...
const Hero = () => {
    return (
        <section className="relative min-h-screen dark:bg-gradient-to-r dark:from-light-gray dark:to-dark-gray flex items-center">
            ...
            <div className="container flex flex-col lg:flex-row items-center justify-between gap-5 my-32 z-[1]">
                <div className="w-full lg:w-1/2">
                    <h2 className="mb-6 text-4xl md:text-5xl !leading-tight font-bold tracking-tight xl:text-6xl">Experienced Web Developer & Photographer</h2>
